...
export default function Contact() {
  ...
  const socialLinks = [
    ...
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/in/basharat-hussain-pk",
      icon: (
        <svg className="w-4 h-4 sm:w-5 sm:h-5 fill-current" viewBox="0 0 24 24">
      ...
      <div className="mx-auto max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-stretch">
        ...
        >
          <div>
            ...
            <div className="space-y-5 mb-8 text-sm sm:text-base text-fg/90">
              {/* Email Row */}
              <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
                <span className="font-mono text-[11px] font-bold text-accent tracking-wider uppercase">
                  EMAIL:
                </span>
                <a
                  href="mailto:basharat81253@gmail.com"
                  className="hover:underline font-semibold text-fg text-sm sm:text-base break-all"
                >
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-1.5 sm:gap-3">
                <span className="font-mono text-[11px] font-bold text-accent tracking-wider uppercase whitespace-nowrap">
                  PHONE / WHATSAPP:
                </span>
                <div className="flex flex-wrap items-center gap-2">
                  <a
                    ...
                    className="font-semibold text-fg hover:text-[#25D366] transition-colors text-sm sm:text-base"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1 text-[10px] font-bold uppercase tracking-wider bg-[#25D366]/15 text-[#25D366] px-2.5 py-0.5 rounded-full border border-[#25D366]/30 hover:bg-[#25D366] hover:text-white transition-colors"
                  >
              ...
              {/* Location Row */}
              <div className="flex flex-col sm:flex-row sm:items-start gap-1 sm:gap-3 text-muted text-xs sm:text-sm">
                <span className="font-mono text-[11px] font-bold text-accent tracking-wider uppercase whitespace-nowrap mt-0.5">
                  LOCATION:
                </span>
                <span className="leading-relaxed">P/o Jokalian, Tehsil Phalia, M.B.Din, Punjab, Pakistan 🇵🇰</span>
              </div>
            </div>
          </div>
